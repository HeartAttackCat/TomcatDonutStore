...
<body>
    ...
    <table>
        ...
        for (Enumeration<Integer> ids = sales.getDonutIds(); ids.hasMoreElements();) {
            ...
            out.write("<td>" + String.format("%.2f", sales.getdQuant().get(id) * donut.getPrice()) + "</td>");
            out.write("</tr>");
        }
        %>
    </table>
    ...
    <div class="report-summary">
        <p>Total Profit: <%= String.format("%.2f", sales.generateTotalSales()) %></p>
        <p>Total Quantity: <%= sales.generateTotalQuantity() %></p>
    </div>
</body>
</html>
